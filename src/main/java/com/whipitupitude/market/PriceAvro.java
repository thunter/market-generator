...
public class PriceAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6432429437106764871L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PriceAvro\",\"namespace\":\"com.whipitupitude.market\",\"fields\":[{\"name\":\"symbol\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"double\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<PriceAvro> ENCODER =
      new BinaryMessageEncoder<PriceAvro>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<PriceAvro> DECODER =
      new BinaryMessageDecoder<PriceAvro>(MODEL$, SCHEMA$);
   ...
   */
  public static PriceAvro fromByteBuffer(
   ...
   * @return A new PriceAvro RecordBuilder
   */
  public static com.whipitupitude.market.PriceAvro.Builder newBuilder(com.whipitupitude.market.PriceAvro.Builder other) {
    if (other == null) {
      return new com.whipitupitude.market.PriceAvro.Builder();
    } else {
  ...
  /**
   * Creates a new PriceAvro RecordBuilder by copying an existing PriceAvro instance.
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<PriceAvro>
    WRITER$ = (org.apache.avro.io.DatumWriter<PriceAvro>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<PriceAvro>
    READER$ = (org.apache.avro.io.DatumReader<PriceAvro>)MODEL$.createDatumReader(SCHEMA$);
